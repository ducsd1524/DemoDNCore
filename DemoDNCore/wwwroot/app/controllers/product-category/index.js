var productCategoryController = function () {
    ...
    function registerEvents() {
        ...
        $('body').on('click', '#btnDelete', function (e) {
            e.preventDefault();
            var that = $('#hidIdM').val();
            sd.confirm('Are you sure to delete?', function () {
                $.ajax({
                    type: "POST",
                    ...
                    success: function (response) {
                        sd.notify('Deleted success', 'success');
                        sd.stopLoading();
                        loadData();
                    },
                    error: function (status) {
                        sd.notify('Has an error in deleting progress', 'error');
                        sd.stopLoading();
                    }
                });
            });
        ...
        $('#btnSave').on('click', function (e) {
            if ($('#frmMaintainance').valid()) {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        sd.notify('Update success', 'success');
                    ...
                    error: function () {
                        sd.notify('Has an error in update progress', 'error');
                        sd.stopLoading();
                    }
                });
            }
